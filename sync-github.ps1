...
# Business Coach Website - Auto Sync Script

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " GitHub Sync - Business Coach Website" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host "✗ ERRORE: Git non è installato o non è nel PATH del sistema." -ForegroundColor Red
...
if (-not (Test-Path ".git")) {
    Write-Host "✗ ERRORE: Questa non è una directory Git." -ForegroundColor Red
...
$commitMessage = "Auto-sync $timestamp - Aggiornamento sito web"
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Repository sincronizzato con GitHub alle $(Get-Date -Format 'HH:mm:ss')" -ForegroundColor Gray
Write-Host ""
Read-Host "Premi Invio per uscire"